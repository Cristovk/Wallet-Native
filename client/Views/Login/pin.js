...
import { View, Text, ScrollView, Button, Image, TouchableOpacity, Alert } from 'react-native'
      ...
      <View>
            <View style ={{flexDirection: "row",width: "100%", justifyContent:"center"}}>
              <View style={style.contentInput}>
                <Input secureTextEntry={true} style={[clave.pin1 ? {borderWidth:1, borderColor:bg, borderRadius:5} : "",style.input]} value={clave.pin1} maxLength={1} ref={pin1}  keyboardType="numeric" onChangeText={(e) => {setClave({...clave,pin1:e})  }}/>
              </View>
              <View style={style.contentInput}>
                  <Input secureTextEntry={true} style={[clave.pin2 ? {borderWidth:1, borderColor:bg, borderRadius:5} : "",style.input]} value={clave.pin2} maxLength={1} ref={pin2} keyboardType="numeric" onChangeText={(e) => {setClave({...clave,pin2:e})}} />
              </View>
              <View style={style.contentInput}>
                <Input secureTextEntry={true} style={[clave.pin3 ? {borderWidth:1, borderColor:bg, borderRadius:5} : "",style.input]} value={clave.pin3} maxLength={1} ref={pin3} keyboardType="numeric" onChangeText={(e) => {setClave({...clave,pin3:e})}} />
              </View>
              <View style={style.contentInput}>
                <Input secureTextEntry={true} style={[clave.pin4 ? {borderWidth:1, borderColor:bg, borderRadius:5} : "",style.input]} value={clave.pin4} maxLength={1} ref={pin4} keyboardType="numeric" onChangeText={(e) => {setClave({...clave,pin4:e});}}  />
              </View>
            </View>
        </View>
